...
CITIES = {
    ...
    "el-paso": {
        "name": "El Paso",
        "crashes": "~15,000+ reported crashes annually in El Paso County",
        "fatalities": "80+ traffic fatalities per year in the metro",
        "injuries": "Heavy I-10 and US-54 cross-border commuter crashes",
        "highways": "I-10, US-54, Loop 375, I-110",
        "hospitals": "UMC El Paso, Las Palmas Medical Center",
        "local_note": "Border metro volume on I-10 and US-54 drives frequent injury claims.",
        "peer_cities": ["houston", "san-antonio", "lubbock", "corpus-christi"],
    },
    "corpus-christi": {
        "name": "Corpus Christi",
        "crashes": "~8,000+ reported crashes in Nueces County",
        "fatalities": "40+ traffic fatalities per year (approx.)",
        "injuries": "Coastal and port traffic on US-181 and SPID",
        "highways": "I-37, US-181, SH 358, Ocean Drive",
        "hospitals": "Christus Spohn, Corpus Christi Medical Center",
        "local_note": "US-181 and SPID corridors see high intersection injury rates.",
        "peer_cities": ["san-antonio", "houston", "el-paso", "austin"],
    },
    "plano": {
        "name": "Plano",
        "crashes": "~6,000+ crashes in Plano / Collin County corridors",
        "fatalities": "20+ fatalities per year in city limits (approx.)",
        "injuries": "US-75 and Bush Turnpike rush-hour collisions",
        "highways": "US-75, Bush Turnpike, SH 121, Dallas North Tollway",
        "hospitals": "Medical City Plano, Texas Health Presbyterian Plano",
        "local_note": "DFW commuter crashes peak on US-75 during rush hour.",
        "peer_cities": ["dallas", "fort-worth", "arlington-texas", "irving"],
    },
    "lubbock": {
        "name": "Lubbock",
        "crashes": "~5,500+ crashes in Lubbock County",
        "fatalities": "30+ traffic deaths per year in regional data",
        "injuries": "I-27 and Loop 289 intersection injuries",
        "highways": "I-27, US-84, Loop 289, Marsha Sharp Freeway",
        "hospitals": "UMC Lubbock (Level I), Covenant Medical Center",
        "local_note": "West Texas high per-capita crash rates on I-27.",
        "peer_cities": ["el-paso", "houston", "san-antonio", "dallas"],
    },
    "arlington-texas": {
        "name": "Arlington",
        "crashes": "~7,000+ crashes in Arlington / Tarrant County",
        "fatalities": "25+ traffic deaths per year (approx.)",
        "injuries": "I-30 entertainment and game-day traffic crashes",
        "highways": "I-30, I-20, US-287, SH 360",
        "hospitals": "Arlington Memorial, Medical City Arlington",
        "local_note": "Between Dallas and Fort Worth — I-30 corridor severity.",
        "peer_cities": ["dallas", "fort-worth", "irving", "plano"],
    },
    "irving": {
        "name": "Irving",
        "crashes": "~5,000+ crashes near DFW Airport and I-635",
        "fatalities": "15+ traffic deaths per year (approx.)",
        "injuries": "Commercial and rideshare crashes on SH 114",
        "highways": "I-635, SH 114, Loop 12, DFW Airport Freeway",
        "hospitals": "Baylor Scott & White Irving, Medical City Las Colinas",
        "local_note": "DFW Airport corridor — preserve rideshare trip records.",
        "peer_cities": ["dallas", "fort-worth", "plano", "arlington-texas"],
    },
}
