...
export const HOME_TRANSLATIONS: Record<Lang, HomeCopy> = {
  en: {
    ...
    step2title: "Sarah Calls You Instantly",
    step2body: "Sarah from WreckMatch calls and texts you within 60 seconds to confirm details and start matching.",
  ...
  es: {
    ...
    step2title: "Sarah te llama al instante",
    step2body: "Sarah de WreckMatch te llama y envía mensaje en 60 segundos para confirmar datos y emparejarte.",
