...
description: >-
  Coverage phases, app-on vs app-off, and passenger vs driver claims after an
  Uber or Lyft crash. General information only.
...
1. **App off** — driver's personal auto policy  
2. **App on, no ride** — limited commercial coverage  
3. **Ride accepted / passenger inside** — higher commercial limits  
...
**Questions?** [Get matched free](/#form) or call **(978) 515-6063**. See [California rideshare-heavy cities](/car-accident-help-california) and [Los Angeles](/car-accident-help-los-angeles).
...
No. WreckMatch LLC is a legal referral service — not a law firm — and we cannot give legal advice or represent you in a case. The blog articles, FAQs, and resources on this site are educational only and reflect general information about rideshare crashs and personal-injury claims. Specific legal questions about your situation should go to a licensed attorney in your state, who can review your facts, the police report, and your medical records before advising you.
...
This guide summarizes what most Uber or Lyft accident victims in your state need after a crash: medical documentation within 24–72 hours, avoiding recorded statements to the other insurer before counsel, and knowing that many personal-injury deadlines in the state are often 2 years from the crash date (verify with a licensed attorney).
...
- [Spanish version / versión en español](https://www.wreckmatch.com/es/blog/rideshare-accident-claims-uber-lyft)
