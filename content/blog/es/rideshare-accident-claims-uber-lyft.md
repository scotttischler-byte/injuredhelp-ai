---
title: Rideshare Accident Claims (Uber/Lyft) — Guía en español — Your Rights
description: >-
  Guía en español: Coverage phases, app-on vs app-off, and passenger vs driver
  claims after an Uber or Lyft crash. General information only.
...
presentationUrl: /blog/presentations/es/rideshare-accident-claims-uber-lyft.pptx
platinumExpansion: true
lang: es
canonicalSlug: rideshare-accident-claims-uber-lyft
presentationUrlEn: /blog/presentations/rideshare-accident-claims-uber-lyft.pptx
---
...
# Rideshare Accident Claims (Uber/Lyft) — Guía en español — Your Rights
...
Nadie puede dar un número exacto sin ver historial médico, reporte policial y pólizas. Promedios publicados (a menudo $15,000 – $250,000+ para accidente de viaje compartido (Uber/Lyft) en EE. UU.) describen casos pasados, no el suyo.
...
### ¿Cuánto tiempo tengo para demandar por un accidente de viaje compartido (Uber/Lyft) en su estado?
...
Resumen para víctimas de accidente de Uber o Lyft en su estado: atención médica en 24–72 horas, evitar declaraciones grabadas a la otra aseguradora antes de hablar con abogado, y plazo habitual de 2 años en muchos casos de lesiones personales (confirme con abogado con licencia).
